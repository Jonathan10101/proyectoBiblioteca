    ...
    <div class="row mt-5">
        ...
        <div class="col">
            ...
            @foreach($coordinadores as $coordinador)
                <a href="{{route('coordinadores.show',$coordinador->id)}}"  class="mb-3 d-inline-block">{{$coordinador->nombre1}} {{$coordinador->nombre2}} {{$coordinador->apellido1}} {{$coordinador->apellido2}}</a><br>
