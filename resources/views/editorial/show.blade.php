...
<div class="">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Detalles de la Editorial</h1>
        </div>
        ...
        <div class="col-12 mt-2 d-flex justify-content-end">
            ...
            <a href="{{route('editoriales.edit',$editorial->id)}}" class="btn btn-outline-dark fas fa-edit ml-2"> Editar</a>
        </div>
        ...
        @php
            $nLibrosEscritos = sizeof($editorial->libro);            
        @endphp
