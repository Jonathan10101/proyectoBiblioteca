...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Editar Coleccion</h1>
        </div>
        ...
        <div class="col">
            <form action="{{route('colecciones.update',$coleccion->id)}}" method="post">                
                ...
                <div class="col d-flex justify-content-center">
                    <input type="text" class="col-5 mt-3 form-control" placeholder="Nombre de la coleccion (Obligatorio)" name="nombre" required value="{{$coleccion->nombre}}">                                    
                </div>
                <div class="col d-flex justify-content-center">
