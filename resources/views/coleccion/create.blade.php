...
<div class="container-fluid mt-2">    
    ...
    <div class="row mt-2">
        <div class="col">
            <h1 class="text-center mb-5">REGISTRAR COLECCION</h1>
        </div>
    </div>
        ...
        <div class="col">
            <form action="{{route('colecciones.store')}}" method="post">
                ...
                <div class="col d-flex justify-content-center">
                    <input type="text" class="col-5 mt-3 form-control" placeholder="Nombre de la coleccion (Obligatorio)" name="nombre" required>                                    
                </div>
                <div class="col d-flex justify-content-center">
