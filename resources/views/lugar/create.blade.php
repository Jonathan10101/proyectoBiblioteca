...
<div class="container-fluid mt-2">    
    ...
    <div class="row mt-2">
        <div class="col">
            <h1 class="text-center mb-5">REGISTRAR LUGAR</h1>
        </div>
    </div>
        ...
        <div class="col">
            <form action="{{route('lugares.store')}}" method="post">
                ...
                <div class="col d-flex justify-content-center">
                    <input type="text" class="col-5 mt-3 form-control" placeholder="Ciudad (Obligatorio)" name="ciudad" required>                                    
                </div>
                <div class="col d-flex justify-content-center">
                    <input type="text" class="col-5 mt-3 form-control" placeholder="Estado" name="estado">                                    
                </div>
                <div class="col d-flex justify-content-center">
                    <input type="text" class="col-5 mt-3 form-control" placeholder="Pais" name="pais">                                    
                </div>
