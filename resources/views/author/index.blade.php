...
<div class="container-fluid mt-2"> 
    ...
    <div class="row mt-2">
        <div class="col">
            <h1 class="text-center">Todos los Autores</h1>
        </div>
    </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col">
            @foreach($autores as $autor)
                <a href="{{route('autores.show',$autor)}}"  class="mb-3 d-inline-block">{{$autor->nombre1}} {{$autor->nombre2}} {{$autor->apellido1}} {{$autor->apellido2}}</a><br>                
            @endforeach
