    ...
    <div class="row">
        ...
        <div class="col-12 mt-4">
            <table class="table inline-flex">       
              ...
              <tbody>
                <tr>
                    <td class="text-center">{{$autor->nombre1}}</td>
                    <td class="text-center">{{$autor->nombre2}}</td>
                    <td class="text-center">{{$autor->apellido1}}</td>
                    <td class="text-center">{{$autor->apellido2}}</td>
                </tr>
              <tbody>
            </table>
        </div>
