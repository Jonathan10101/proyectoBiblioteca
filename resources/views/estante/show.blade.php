...
<div class="">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Detalles del Estante</h1>
        </div>
        ...
        <div class="col-12 mt-2 d-flex justify-content-end">
            ...
            <a href="{{route('estantes.edit',$estante->id)}}" class="btn btn-outline-dark fas fa-edit ml-2"> Editar</a>
        </div>
        ...
        @php
            $nLibrosEscritos = sizeof($estante->libro);            
        @endphp
            ...
            <table class="table inline-flex">       
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$estante->libro[$i]['titulo']}}</td>
                    <td class="text-center">{{$estante->libro[$i]['year']}}</td>
                    <td class="text-center">{{$estante->libro[$i]['observacion']}}</td>
                    <td class="text-center"><a href="{{route('books.show',$estante->libro[$i]['id'])}}">Ver</a></td>
                </tr>
                @endfor
              <tbody>
            </table>
