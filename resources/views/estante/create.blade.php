...
<div class="container-fluid mt-2">   
    ...
    <div class="row mt-2">
        <div class="col">
            <h1 class="text-center mb-3">REGISTRAR ESTANTE</h1>
        </div>
    </div>
        ...
        <div class="col">
            <form action="{{route('estantes.store')}}" method="post">
                ...
                <div class="col d-flex justify-content-center">
                    <input type="text" class="col-5 mt-3 form-control" placeholder="Numero de estante (Solo numeros)" name="estante" pattern="[1234567890]+" required>                                    
                </div>
                <div class="col d-flex justify-content-center">
